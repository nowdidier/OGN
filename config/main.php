...
return [
    ...
    │ во всех реализациях иметь один общий ('en' - английский или 'ki' - русский).
    │ Изначально: 'en'
    │
    */
    'default.lang' => 'en',
    ...
    │ Изначально: ['en', 'ki', 'de', 'es', 'zh']
    │
    */
    'allowed.languages' => ['en', 'ru', 'de', 'es', 'zh', 'ki'],
    ...
    */
    ...
    // New configuration enhancements
    'app.debug'      => false,  // Enable or disable debug mode.
    'app.timezone'   => 'UTC',  // Default timezone.
    'cache.enabled'  => true,   // Enable caching mechanism.
    'cache.lifetime' => 3600,   // Cache lifetime in seconds.
    ...
    'allowed.resources' => [
        ...
        'connect-src' => [
            'wss://api.example.com', // allow secure WebSocket connections
        ],
    ],
];
